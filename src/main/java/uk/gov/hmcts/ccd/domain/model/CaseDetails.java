...
import static uk.gov.hmcts.ccd.domain.model.FieldType.CASE_PAYMENT_HISTORY_VIEWER;
import static uk.gov.hmcts.ccd.domain.model.FieldType.LABEL;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.CASE_REFERENCE;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.CASE_TYPE;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.CREATED_DATE;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.JURISDICTION;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.LAST_MODIFIED_DATE;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.SECURITY_CLASSIFICATION;
import static uk.gov.hmcts.ccd.domain.model.MetaData.CaseField.STATE;
